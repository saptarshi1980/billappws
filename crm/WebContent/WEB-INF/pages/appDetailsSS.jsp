...
<div align="center">
<form name="form1" method="post" action="updatePrelSS.dpl">
<table border="1">
      ...
      <c:forEach items="${list}" var="row">
        <tr>
          ...
          <input type="hidden" name="ss_code" value="${sessionScope.ssCode}">
    ...
    <tr>
    <td bgcolor="#999999"><div align="center">Select Mode of Cabling</div></td>
    <td><select name="cb">
    ...
    <TR><td bgcolor="#999999">Cable Length (in meters)</td><td><input type="text" name="length"/></TR>
    <TR><td bgcolor="#999999">Remarks</td><td><input type="text" name="remarks"/></TR>
    <tr>
