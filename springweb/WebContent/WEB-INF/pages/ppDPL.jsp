...
<ul>
   ...
   <li class='active has-sub'><a href='#'><span>About DPL</span></a>
      <ul>
      	 ...
      	 <li class='last'><a href="ppDPL.dpl"><span>Power Plants</span></a> </li>
      	 <li class='last'><a href="cogpDPL.dpl"><span>Coke Oven Plant</span></a> </li>
      	 <li class='last'><a href="wwDPL.dpl"><span>Water Works</span></a> </li>
         ...
         <li class='last'><a href="aboutDPL.dpl"><span>About DPL</span></a> </li>
      </ul>
   </li>
...
<div class="title">Power Plants of Durgapur Projects Limited</div>
<font size="2.5">The Durgapur Projects Limited's total power generation capacity after the recent renovation and upgradation, today stands at 641 megawatt (MW). It is engaged in all the three functional areas of a power utility -Generation, Transmission and Distribution.It generates and distributes power in an uninterrupted mode at grid frequency.It has a cluster of five active generation units of different capacities. The largest unit is of 300 MW capacity followed by one of 110 MW unit and three of 77 MW each. The power tariff it offers to all its end users, is reasonably cheaper than many other power utilities in the country. <br></br>
The growth in power in the DPL command area is around 20% per annum, the current demand being around 300 MW which is about 45% of the total power generation capacity of the utility. It meets local demand through its captive transmission and distribution networks. </font><br />
<br />
		<div class="section_box2" align="justify">
        <div class="post_title">Power Plant Details</div>
        <div class="text_area">
               Put PP Details Here
        </div>
       ...
       <!--  <div class="publish_date">Post Date: 24-10-2020 · Tags: <a href="#">Flash</a> · <a href="#">ActionScripts</a> · <a href="#">Full Story</a></div> -->
    	...
    	<div id="templatemo_right_column">
            ...
            <ul class="templatemo_menu">
              <li><a href="Home.dpl">Homepage</a></li>
